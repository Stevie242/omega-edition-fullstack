...
const STORAGE_KEY = 'reader.ui.appearance';
...
<template>
    <ReaderLayout
        title="Apparence"
        description="Thème clair/sombre et devise d’affichage pour la lecture."
        :breadcrumbs="[
            ...
            <Card class="lg:col-span-2">
                ...
                <CardContent class="flex flex-wrap items-center gap-3">
                    ...
                    <p class="text-xs text-muted-foreground">
                        Ces réglages sont stockés dans votre navigateur. À connecter plus tard à une sauvegarde serveur si besoin.
                    </p>
                </CardContent>
            </Card>
        </div>
