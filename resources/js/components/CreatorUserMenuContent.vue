...
<template>
    ...
    <DropdownMenuGroup>
        <DropdownMenuItem :as-child="true">
            <Link class="block w-full" href="/creator/settings/profile" prefetch as="button">
                <Settings class="mr-2 h-4 w-4" />
                Profil
            </Link>
        </DropdownMenuItem>
        <DropdownMenuItem :as-child="true">
            <Link class="block w-full" href="/creator/settings/appearance" prefetch as="button">
        ...
        <DropdownMenuItem :as-child="true">
            <Link class="block w-full" href="/creator/settings/two-factor" prefetch as="button">
